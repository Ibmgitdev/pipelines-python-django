...
|---------|--------------|
| Build [![Build status](https://dev.azure.com/Ibmgitdev/pipelines-python-django/_apis/build/status/Ibmgitdev.pipelines-python-django?branchName=master).].(https://dev.azure.com/Ibmgitdev/pipelines-python-django/_build/latest?definitionId=2?branchName=master) |
